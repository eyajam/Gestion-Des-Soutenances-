<template>
    ...
    const steps = ref([
      ...
      { image: '/images/Add project.png', description: 'You can add a project from the list of unsupervised students, but once the timer stops, the administrator will randomly assign you a project.' },
    ]);
